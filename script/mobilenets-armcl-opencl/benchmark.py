...
request_uid='08da9685582866a0' # unique UID for a given ReQuEST submission generated manually by user (ck uid)
        ...
        for model_uoa in udepm:
            ...
            ii={'action':'autotune',
               ...
               'record_dict':{
                     ...
                     'request_submission_uid':request_uid,  # unique UID for a given ReQuEST submission generated by user
